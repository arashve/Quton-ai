  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-2.5 sm:px-3.5 pt-2 pb-1 text-xs bg-zinc-200/50 dark:bg-zinc-800/40">
          <div className="flex items-center gap-1 sm:gap-1.5 flex-wrap">
            ...
            <button
              ...
              className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-[10px] sm:text-[11px] font-medium transition cursor-pointer ${
                deepThinkEnabled
        ...
        <div className="relative px-3 sm:px-4 pt-2 pb-1.5 sm:pt-2.5 sm:pb-2">
          <textarea
            ...
            className="w-full bg-transparent text-sm sm:text-base text-zinc-900 dark:text-zinc-100 placeholder:text-zinc-400 dark:placeholder:text-zinc-500 resize-none outline-none focus:outline-none focus:ring-0 leading-relaxed max-h-[180px] sm:max-h-[220px] transition-[height] duration-100 ease-out"
          />
        </div>

        {/* Bottom Actions Row */}
        <div className="flex items-center justify-between px-2.5 sm:px-3.5 pb-2 sm:pb-2.5 pt-1 gap-2">
          <div className="flex items-center gap-1.5 relative">
            ...
            <div className="relative">
              <button
                ...
                className="p-1.5 sm:p-2 rounded-lg text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-200 hover:bg-zinc-200 dark:hover:bg-zinc-800 transition cursor-pointer"
            ...
            {inputPrompt.trim().length > 3 && (
              <motion.button
                ...
                className="inline-flex items-center gap-1.5 px-2 sm:px-2.5 py-1.5 rounded-lg bg-zinc-200 dark:bg-zinc-800 hover:bg-zinc-300 dark:hover:bg-zinc-700 text-zinc-800 dark:text-zinc-200 text-xs transition cursor-pointer active:scale-95"
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            {isLoading ? (
              <motion.button
                ...
                onClick={onAbort}
                className="w-9 h-9 sm:w-8 sm:h-8 rounded-lg bg-red-600 hover:bg-red-700 text-white flex items-center justify-center transition cursor-pointer shadow-sm"
